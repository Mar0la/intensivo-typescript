...
import { MissingParamError, InvalidParamError, ServerError } from '../err/index'
import { EmailValidator } from '../protocols/email-validator'
import { AddAccount, AddAccountModel } from '../../domain/presentation/add.account'
...
describe('SignUp Controller', () => {
  ...
  test('Should return 400 if no confirmantion password is provided', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should call EmailValidtaor with correct email', () => {
    const { sut, emailValidatorStub } = makeSut()
